...
class FCFSSchedulerStrategy:
    key: str = "fcfs"
    display_name: str = "FCFS"
    description: str = "First-Come, First-Served không preemptive, xử lý theo thứ tự đến."
    ...
    def simulate(
        ...
        ready: deque[tuple[int, ProcessInput]] = deque()
